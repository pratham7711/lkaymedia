    ...
    <div className=" h-auto flex flex-col">
      ...
      <div className=" h-[20rem] flex items-center justify-between p-3 text-white  gap-2">
        <div className="flex flex-col gap-2 items-start justify-center  ml-[7rem] w-auto">
          ...
          <p className="text-sm text-[#7D7D7D] ">
            Find the concert of your choice and watch it through our
            <br />
            platform that has been visited by thousands of people.
          </p>
          <div className=" w-full h-auto flex items-center justify-between ">
            <div className="flex flex-col items-start justify-center">
              <span className="font-bold text-[2.5rem] text-transparent bg-[linear-gradient(90deg,_#74D4ED_43.35%,_#A7A8FF_50.76%,_#C994DF_67.5%,_#DAB4FF_77.93%)] bg-clip-text">
                120K
              </span>
              <p className="text-sm text-[#7D7D7D]">Reels Created</p>
            </div>
            <div className="flex flex-col items-start justify-center">
              <span className="font-bold text-[2.5rem] text-transparent bg-[linear-gradient(90deg,_#74D4ED_43.35%,_#A7A8FF_50.76%,_#C994DF_67.5%,_#DAB4FF_77.93%)] bg-clip-text">
                82M
              </span>
              <p className="text-sm text-[#7D7D7D]">Total Views</p>
            </div>
            <div className="flex flex-col items-start justify-center">
              <span className="font-bold text-[2.5rem] text-transparent bg-[linear-gradient(90deg,_#74D4ED_43.35%,_#A7A8FF_50.76%,_#C994DF_67.5%,_#DAB4FF_77.93%)] bg-clip-text">
                56K
              </span>
              <p className="text-sm text-[#7D7D7D]">Viral Hits</p>
            </div>
          </div>
        </div>
