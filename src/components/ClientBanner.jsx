...
const ClientBanner = () => {
  return (
    <div className="text-white mt-[15rem] flex flex-col items-center justify-center ">
      <span className="w-auto text-[5rem] font-extrabold ">
        What we do 
      ...
      {/* <span className="text-2xl text-[#aaaaaa] w-[40rem] mt-[2rem]">
      We create highly engaging video on social media platforms
      </span>
